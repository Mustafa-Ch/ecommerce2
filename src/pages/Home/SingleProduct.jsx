...
import { FaArrowAltCircleRight, FaNutritionix, FaStar } from "react-icons/fa";
...
const SingleProduct = () => {
  ...
  const {ids}=useParams();
  const product=myState.filter((e)=>{
    return e.id===Number(ids);
  })
...
// console.log(product[0])
    const {image, name, new_price,id} = product[0];
